...
#ifndef GTL_SCALE3_INCL_
#define GTL_SCALE3_INCL_

// Cannot be included before <gtl/scale.h>
#ifndef GTL_SCALE_INCL_
#error Do not include <gtl/bits/scale3.h> directly; include <gtl/scale.h> instead.
#endif
...
namespace gtl
{
    ...
    class scale< _ComponentType, 3 >
    {
        // Convenience typedef
        typedef scale< _ComponentType, 3 > _Self;
    ...
    public:
         ...
         */
        scale(const vector3_type & vector_)
        ...
        /**  Set scale using a 4x4 scale matrix  */
        ...
        /**  Get scale as a 4x4 scale matrix  */
        ...
        /**  Get scale of z azis.  */
        component_type z() const
            { return this->_vector.z(); }

        /**  Set scale of z azis.  */
        void z(const component_type & z_)
            { this->_vector.z(z_); }
        ...
        vector3_type operator * (const vector3_type & rhs_) const
            {
                return vector3_type(this->_vector.x() * rhs_.x(),
                                    this->_vector.y() * rhs_.y(),
                                    this->_vector.z() * rhs_.z());
            }
     ...
     */
    template< typename _ComponentType >
    std::ostream & operator << (std::ostream & os, const scale< _ComponentType, 3 > & rhs_)
    {
        _ComponentType angle;
        rhs_.to_angle(angle);
        os << "scale3D(" << rhs_.x() << ", " << rhs_.y() << ", " << rhs_.z() << ")";
        return os;
    }

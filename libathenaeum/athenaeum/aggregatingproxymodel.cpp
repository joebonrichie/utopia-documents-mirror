...
#include <athenaeum/aggregatingproxymodel_p.h>
...
namespace Athenaeum
{
    ...
    void AggregatingProxyModelPrivate::on_dataChanged(const QModelIndex & topLeft, const QModelIndex & bottomRight)
    {}
    ...
    bool AggregatingProxyModel::dropMimeData(const QMimeData * data, Qt::DropAction action, int row, int column, const QModelIndex & parent)
    {
        return false;
    }

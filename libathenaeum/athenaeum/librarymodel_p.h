...
namespace Athenaeum
{
    ...
    public:
        ...
        QList< AbstractBibliographicModel * > models;
        QMap< AbstractBibliographicModel *, QList< SortFilterProxyModel * > > filters;
        QList< RemoteQueryBibliographicModel * > searches;
        QStringList mimeTypes;

        void connectModel(AbstractBibliographicModel * model);
        void disconnectModel(AbstractBibliographicModel * model);
        void relayDataChanged();
        QModelIndex modelParentIndex() const;
    ...
    public slots:
        ...
        void onStateChanged(Athenaeum::AbstractBibliographicCollection::State state);

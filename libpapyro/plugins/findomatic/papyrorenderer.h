...
#ifndef PAPYRORENDERER_H
#define PAPYRORENDERER_H
...
class PapyroRenderer : public FINDOMATIC::AbstractRenderer
{
public:
    // Constructor
    PapyroRenderer();
    // Destructor
    virtual ~PapyroRenderer();
...
private:
    QHash< QModelIndex, QImage  > iconPreviewMap;

}; // class PapyroRenderer

#endif // PAPYRORENDERER_H

...
namespace Papyro
{
    ...
    class ExploringProcessor : public SelectionProcessor
    {
    public:
        int category() const;
    ...
    }; // class ExploringProcessor




    class ExploringProcessorFactory : public SelectionProcessorFactory
    {
    public:
        QList< boost::shared_ptr< SelectionProcessor > > selectionProcessors(Spine::DocumentHandle document, Spine::CursorHandle cursor);

    }; // class ExploringProcessorFactory

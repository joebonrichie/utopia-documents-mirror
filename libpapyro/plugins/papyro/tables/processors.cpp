...
extern "C" void utopia_registerExtensions()
{
    ...
    UTOPIA_REGISTER_TYPED_EXTENSION(Papyro::SelectionProcessor, TableFactory)
#endif
    UTOPIA_REGISTER_TYPED_EXTENSION(Papyro::AnnotationProcessor, TableFactory)
    UTOPIA_REGISTER_EXTENSION(TablingRenderer)
}

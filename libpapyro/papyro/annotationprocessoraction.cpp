...
namespace Papyro
{
    ...
    AnnotationProcessorAction::~AnnotationProcessorAction()
    {}

    void AnnotationProcessorAction::onTriggered()
    {
        if (factory && !annotations.empty()) {
            factory->activate(document, annotations);
        }
    }

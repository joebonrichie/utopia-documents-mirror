...
#include "securitypreferencespane.h"
...
{
    return "Standard Utopia preference panes";
}

extern "C" void utopia_registerExtensions()
{
    UTOPIA_REGISTER_EXTENSION(NetworkingPreferencesPane);
    //UTOPIA_REGISTER_EXTENSION(SecurityPreferencesPane);
    UTOPIA_REGISTER_EXTENSION(PluginsPreferencesPane);

    UTOPIA_REGISTER_EXTENSION(NetworkingPreferencesDefaults);
}

...
#ifndef PDFTEXTBLOCKCOLLECTION_INCL_
#define PDFTEXTBLOCKCOLLECTION_INCL_

/*****************************************************************************
 *
 * PDFTextBlockCollection.h
 *
...
namespace Crackle
{
    ...
    typedef Crackle::SimpleCollection< PDFTextBlock > PDFTextBlockCollection;

}

#endif /* PDFTEXTBLOCKCOLLECTION_INCL_ */

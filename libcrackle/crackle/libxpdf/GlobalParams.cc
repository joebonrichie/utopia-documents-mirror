...
static struct {
    ...
    {"Courier",               "n022003l.pfb", "Courier New.ttf"},
    {"Courier-Bold",          "n022004l.pfb", "Courier New Bold.ttf"},
    {"Courier-BoldOblique",   "n022024l.pfb", "Courier New Bold Italic.ttf"},
    {"Courier-Oblique",       "n022023l.pfb", "Courier New Italic.ttf"},
    {"Helvetica",             "n019003l.pfb", "Arial.ttf"},
    {"Helvetica-Bold",        "n019004l.pfb", "Arial Bold.ttf"},
    {"Helvetica-BoldOblique", "n019024l.pfb", "Arial Bold Italic.ttf"},
    {"Helvetica-Oblique",     "n019023l.pfb", "Arial Italic.ttf"},
    {"Symbol",                "s050000l.pfb", 0},
    {"Times-Bold",            "n021004l.pfb", "Times New Roman Bold.ttf"},
    {"Times-BoldItalic",      "n021024l.pfb", "Times New Roman Bold Italic.ttf"},
    {"Times-Italic",          "n021023l.pfb", "Times New Roman Italic.ttf"},
    {"Times-Roman",           "n021003l.pfb", "Times New Roman.ttf"},
    {"ZapfDingbats",          "d050000l.pfb", "Wingdings.ttf"},
    {NULL}
};
...
#if 0 // prevent default config loading
...
void GlobalParams::setupBaseFonts(char *dir) {
    ...
    for (i = 0; displayFontTab[i].name; ++i) {
        ...
        for (j = 0; !fileName && displayFontDirs[j]; ++j) {
            ...
            if(!fileName && displayFontTab[i].t1FileName) {
                fileName = appendToPath(new GString(displayFontDirs[j]),

...
#ifndef PDFTEXTREGIONCOLLECTION_INCL_
#define PDFTEXTREGIONCOLLECTION_INCL_

/*****************************************************************************
 *
 * PDFTextRegionCollection.h
 *
...
namespace Crackle
{
    ...
    typedef Crackle::SimpleCollection< PDFTextRegion > PDFTextRegionCollection;

}

#endif /* PDFTEXTREGIONCOLLECTION_INCL_ */

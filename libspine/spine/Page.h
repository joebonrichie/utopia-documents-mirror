...
namespace Spine
{
    ...
    public:
        ...
        /* These four might stay, but will probably go as they may not mean anything
           to any back end other than Crackle. For testing at the moment. */
        /*
        ...
        */
        ...
        virtual Image render(size_t width_, size_t height_) const=0;
        virtual Image render(double resolution_) const=0;
        virtual Image renderArea(const BoundingBox & slice, size_t width_, size_t height_) const=0;
        virtual Image renderArea(const BoundingBox & slice, double resolution_) const=0;

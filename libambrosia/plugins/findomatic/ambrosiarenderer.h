...
#ifndef AMBROSIARENDERER_H
#define AMBROSIARENDERER_H

#include <findomatic/abstractrenderer.h>

class AmbrosiaRenderer : public FINDOMATIC::AbstractRenderer
{
public:
    // Constructor
    AmbrosiaRenderer();
    // Destructor
    virtual ~AmbrosiaRenderer();
...
}; // class AmbrosiaRenderer

#endif // AMBROSIARENDERER_H
